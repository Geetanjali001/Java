/*WAP to input integer elements in 2D array and print sum of the each row
   2DArray Elements
...
public class SumOfEachRowElementsIn2DArray {
	...
	public static void main(String[] args) {
		...
		int sum=0;
   for (int i=0;i<3;i++){
	   sum=0;// i=0:condition true, i=1: condition true
	   for (int j=0;j<3;j++) {//j=0: condition true, j=1: condition true, j=2: condition true
		   ...
		   sum=sum+a[i][j];// sum=0, j=2: 0+2, sum=2||j=4: 2+4, sum=6||j=6: 6+6=12
